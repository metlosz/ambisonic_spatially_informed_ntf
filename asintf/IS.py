...
class IS(NTFBase):
    ...
    def update_Q(self):
        ...
        q_n = einsum('fk, tk, ftab, ftab, ftab, jab -> jk', self._W, self._H, hatRinv, self._R, hatRinv, self._XI,
                     optimize=self._Q_path[0])
    ...
    def update_W(self):
        hatRinv = pinv(self._hatR.sum(0))
        w_n = einsum('jk, tk, ftab, ftab, ftab, jab -> fk', self._Q, self._H, hatRinv, self._R, hatRinv, self._XI,
                     optimize=self._W_path[0])
    ...
    def update_H(self):
        hatRinv = pinv(self._hatR.sum(0))
        h_n = einsum('jk, fk, ftab, ftab, ftab, jab -> tk', self._Q, self._W, hatRinv, self._R, hatRinv, self._XI,
                     optimize=self._H_path[0])
    ...
    def _H_path(self):
        H_path = [
            einsum_path('jk, fk, ftab, ftab, ftab, jab -> tk', self._Q, self._W,
    ...
    def _Q_path(self):
        Q_path = [
            einsum_path('fk, tk, ftab, ftab, ftab, jab -> jk', self._W, self._H,
                        empty((self._F, self._T, self._L, self._L)), self._R,
                        empty((self._F, self._T, self._L, self._L)), self._XI, optimize='optimal')[0],
    ...
    def _W_path(self):
        W_path = [
            einsum_path('jk, tk, ftab, ftab, ftab, jab -> fk', self._Q, self._H,
                        empty((self._F, self._T, self._L, self._L)), self._R,
                        empty((self._F, self._T, self._L, self._L)), self._XI, optimize='optimal')[0],
